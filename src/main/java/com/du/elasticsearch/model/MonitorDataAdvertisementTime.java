 ...
 * @date 2019/3/1 21:02
 */
public class MonitorDataAdvertisementTime {
	/**
	 * 监播数据广告ID
	 */
	private Long monitorDataAdvertisementTimeId;
	/**
	 * 广告名称
	 */
	...
	public Long getMonitorDataAdvertisementTimeId() {
		return monitorDataAdvertisementTimeId;
	}

	public void setMonitorDataAdvertisementTimeId(Long monitorDataAdvertisementTimeId) {
		this.monitorDataAdvertisementTimeId = monitorDataAdvertisementTimeId;
	}
